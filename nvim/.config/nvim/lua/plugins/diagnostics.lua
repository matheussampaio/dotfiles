...
vim.api.nvim_set_keymap('n', '<Leader>df', '<cmd>lua vim.diagnostic.open_float()<CR>', { noremap = true, silent = true, desc = "Diagnostic open float" })
vim.api.nvim_set_keymap('n', '<Leader>dl', '<cmd>lua vim.diagnostic.setloclist()<CR>', { noremap = true, silent = true, desc = "Load diagnostics to loc list" })
