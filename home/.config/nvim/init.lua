...
local plugins = {
  ...
  {
    'mattn/emmet-vim',
    ft = { 'html', 'vue', 'javascriptreact', 'riot', 'typescriptreact' },
    init = function()
    ...
    config = function()
      vim.api.nvim_create_autocmd('FileType', {
        group = vim.api.nvim_create_augroup('EmmetInstall', { clear = false }),
        pattern = { 'css', 'html', 'javascript', 'javascriptreact', 'typescriptreact', 'vue' },
        callback = function()
          vim.cmd([[
            EmmetInstall
          ]])
  ...
  -- splitting/joining blocks of code
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<Leader>ua', require('treesj').toggle, { desc = 'Toggle node under cursor (split if one-line and join if multiline)' })
    end,
  },
  ...
  -- open/close Quickfix and Localfix
  {
    ...
    config = function()
      vim.keymap.set('n', '<Leader>tq', function()
        vim.cmd([[:call ToggleQuickfixList()]])
      end, { desc = 'Toggle Quickfix list' })
      vim.keymap.set('n', '<Leader>tl', function()
        vim.cmd([[:call ToggleLocationList()]])
      end, { desc = 'Toggle loc list' })
    end,
  },
}
