...
-- Diagnostic keymaps
-- NOTE: v0.10.0 provides default keybindings to navigate diagnostics.
--
...
vim.api.nvim_create_autocmd('TextYankPost', {
  ...
  callback = function()
    vim.highlight.on_yank { timeout_ms = 500 }
  end,
})
...
require('lazy').setup({
  ...
  'christoomey/vim-tmux-navigator', -- move outside vim to another tmux pane easily
  ...
  -- NOTE: Automatically adds plugins from `lua/plugins/*.lua`
  -- { import = 'plugins' },
}, {
  ui = {
